...
export class RecipeListComponent implements OnInit {
  ...
  recipes : Recipe[]=[
    ...
    ,new Recipe("cde","345","https://images.immediate.co.uk/production/volatile/sites/30/2020/08/chorizo-mozarella-gnocchi-bake-cropped-9ab73a3.jpg?quality=90&resize=556,505" )
